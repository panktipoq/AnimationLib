...
public final class AZDropdownMenuDefaultCell: AZDropdownMenuBaseCell {
    ...
    fileprivate func constraintsForRightAlignment(_ viewBindings: [String:AnyObject]) -> [NSLayoutConstraint] {
        return NSLayoutConstraint.constraints(withVisualFormat: "H:[icon]-10-[title]-|", options: NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: viewBindings)
    }

    fileprivate func constraintsForCenterAlignment(_ viewBindings: [String:AnyObject]) -> [NSLayoutConstraint] {
        var constraints = NSLayoutConstraint.constraints(withVisualFormat: "H:[icon]-10-[title]", options: NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: viewBindings)
